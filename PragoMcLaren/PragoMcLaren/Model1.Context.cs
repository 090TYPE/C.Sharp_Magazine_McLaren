...
namespace PragoMcLaren
{
    ...
    public partial class McLarenEntities1 : DbContext
    {
        public McLarenEntities1()
            : base("name=McLarenEntities1")
        {
        }
        ...
        public virtual DbSet<АвтомобилиИЗапчасти> АвтомобилиИЗапчасти { get; set; }
